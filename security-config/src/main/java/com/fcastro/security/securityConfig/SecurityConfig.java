...
import com.fcastro.security.auth.CustomAccessDeniedHandler;
import com.fcastro.security.auth.CustomAuthenticationEntryPointHandler;
...
public class SecurityConfig {
    ...
    RestClient authorizationServer(PropertiesConfig securityConfigData, JWTHandler jwtHandler) {
