...
public class GlobalExceptionHandler {
    ...
    static {
        ...
        exceptionTypes.put(PantryServiceException.class, "application-internal-error");
    }
    ...
    public ResponseEntity<?> badRequest(final Exception ex, final HttpServletRequest request) {
        final var error = com.fcastro.pantry.config.ApplicationError.builder()
    ...
    public ResponseEntity<?> databaseException(final DataAccessException ex, final HttpServletRequest request) {
        ...
        var error = com.fcastro.pantry.config.ApplicationError.builder()
                .timestamp(Clock.systemUTC().millis())
    ...
    @ExceptionHandler(value = {PantryServiceException.class})
    public ResponseEntity<?> applicationException(final PantryServiceException ex, final HttpServletRequest request) {

        LOGGER.error("Pantry Service error ", ex);
