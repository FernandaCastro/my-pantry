...
INSERT INTO PANTRY_ITEM (PANTRY_ID, PRODUCT_ID, IDEAL_QTY, CURRENT_QTY) VALUES (1, 1, 5, 5) ON CONFLICT(PANTRY_ID, PRODUCT_ID) DO NOTHING;
INSERT INTO PANTRY_ITEM (PANTRY_ID, PRODUCT_ID, IDEAL_QTY, CURRENT_QTY) VALUES (1, 2, 4, 4) ON CONFLICT(PANTRY_ID, PRODUCT_ID) DO NOTHING