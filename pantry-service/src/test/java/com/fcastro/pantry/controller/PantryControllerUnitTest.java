...
import com.fcastro.pantry.service.PantryService;
...
public class PantryControllerUnitTest {
    ...
    public void givenValidPantryId_whenGet_shouldReturnOk() throws Exception {
        //given
        var products = new ArrayList<PantryProductDto>();
        products.add(PantryProductDto.builder()
                .pantry(PantryDto.builder().id(1).build())
                .product(ProductDto.builder().id(1).build())
                .idealQty(5)
                .currentQty(5).build());

        var pantry = PantryDto.builder().id(1).name("Base Inventory").active(true).type("R").products(products).build();
    ...
    public void whenGetAll_shouldReturnOk() throws Exception {
        ...
        list.add(PantryDto.builder().id(1).name("Base Inventory").active(true).type("R").build());
        list.add(PantryDto.builder().id(2).name("Base Inventory").active(true).type("R").build());
    ...
    public void givenNewPantry_whenCreate_shouldReturnCreated() throws Exception {
        //given
        var pantry = PantryDto.builder().id(10).name("New Base Inventory").active(true).type("R").build();
    ...
    public void givenValidPantryId_whenReplace_shouldReturnCreated() throws Exception {
        //given
        var pantry = PantryDto.builder().id(10).name("Updated Base Inventory").active(true).type("R").build();
